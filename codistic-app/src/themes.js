export const THEMES = {
  dark: {
    ...
    text: "#e2e8f0", textMuted: "#4a5568", textDim: "#6b7a8d",
  ...
  light: {
    ...
    text: "#1a1a2e", textMuted: "#94a3b8", textDim: "#94a3b8",
  ...
  retro: {
    ...
    text: "#00ff41", textMuted: "#1a5c1a", textDim: "#2d6b2d",
  ...
  solarized: {
    ...
    text: "#839496", textMuted: "#586e75", textDim: "#4a6b75",
  ...
  nord: {
    ...
    text: "#d8dee9", textMuted: "#616e88", textDim: "#6b7a8d",
  ...
  catppuccin: {
    ...
    text: "#cdd6f4", textMuted: "#6c7086", textDim: "#6b7280",
