    ...
    <>
      <style>{`
        ...
        .vkb-key {
          ...
          flex-direction: column;
          cursor: default;
          transition: background 0.1s ease, color 0.1s ease, border-color 0.1s ease, transform 0.1s ease, box-shadow 0.1s ease;
          position: relative;
          overflow: hidden;
        }
        ...
        @media (prefers-reduced-motion: reduce) {
          .vkb-key.vkb-next::after { animation: none; }
          .vkb-key { transition: none; }
        }
      `}</style>
      ...
      {!dragPos ? (
        ...
        >
          ...
          <button className="vkb-hide-btn" title="Ctrl + K" aria-label="Hide virtual keyboard, shortcut Ctrl K" onClick={onHide}>
